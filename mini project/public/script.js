...
var mainControllers = angular.module('mainControllers', ['ui.bootstrap']);
mainControllers.controller("mainCtrl", ['$scope', 'machineListService', 'metricInfoService', 'notificationDetailService', 'alertDetailsService', function($scope, machineListService, metricInfoService, notificationDetailService, alertDetailsService) {
...
mainControllers.filter('duplicates', function() {
    return function(mac) {
        var arr = [];
